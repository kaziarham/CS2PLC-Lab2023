...
//             assert ?? : "power: Integer overflow";
    ...
    */
    private static List<Float> power_fp(float n, int m)
    {
        ...
        {
            ns = ns * n;
            assert ns < Double.POSITIVE_INFINITY : "Floating-point overflow";   // Task 3b - Assertion on FP overflow
            resultList.add(ns);
        }
        return resultList;
    }
    ...
    */
    private static List<Float> geom_fp(float n, int m)
    {
        ...
        for ( int j = 0; j <= m; j++ )
        {
            ...
            assert ns_inv > 0 : "Floating point underflow"; // Task 3b - Assertion on FP underflow
